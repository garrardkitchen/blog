...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.c71df1189ded5569abcdeaf417c6b9606e3040bec7395822d05a5a42e6e5994f.js',function(){input.required=false;search();});}
