...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.81a7577d4c706204b57078e116c5418db032d796f2988cecd08cadf08310f766.js',function(){input.required=false;search();});}
