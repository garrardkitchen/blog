...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.64fbfa75c3d397bba6a41cb8426a5e9628c1b11d7731e1a273eab84f99584c3e.js',function(){input.required=false;search();});}
