...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.40e1b419470061834620ae9dffab3d938ece5a5e559197c896ffb4f90bd3b95e.js',function(){input.required=false;search();});}
