...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f4b443057cc64c3030fc5e90d97e6424753e0ed7bebf2ef640d06cb439b3a367.js',function(){input.required=false;search();});}
