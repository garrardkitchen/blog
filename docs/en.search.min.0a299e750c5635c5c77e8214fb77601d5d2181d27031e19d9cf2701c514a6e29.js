...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.53e2d6beda00285c2249eeea901a2e007873afdf24e4867b40bdbc79d92e4b52.js',function(){input.required=false;search();});}
