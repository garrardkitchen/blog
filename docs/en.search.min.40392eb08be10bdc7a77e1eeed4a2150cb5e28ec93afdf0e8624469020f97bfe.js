...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.215619d433ad5ae59e0483132a23da9a47fa6ad707ac842aa79cd4efe8543f90.js',function(){input.required=false;search();});}
