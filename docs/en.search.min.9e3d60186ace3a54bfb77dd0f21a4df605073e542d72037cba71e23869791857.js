...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.ebec67a25baad2a3fadf3ef261a5ff8a1707538a9b217606f2038d48e0e43fcf.js',function(){input.required=false;search();});}
