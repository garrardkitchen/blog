...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.95f2b07234d5706c4a43a3ffe10765207768b3866b3e1a9889e52ff362261fef.js',function(){input.required=false;search();});}
