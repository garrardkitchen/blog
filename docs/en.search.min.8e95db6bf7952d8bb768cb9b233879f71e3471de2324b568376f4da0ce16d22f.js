...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.b008de863467e91d0192f26eec21b0128696f2c37050aa75eaccaafbe29a8d9e.js',function(){input.required=false;search();});}
