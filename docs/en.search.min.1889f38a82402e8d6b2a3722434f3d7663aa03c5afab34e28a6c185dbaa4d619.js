...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.317aff44632728490122cec70b36cbdcb4cf80fb188afdd5940c44208a82bc3d.js',function(){input.required=false;search();});}
