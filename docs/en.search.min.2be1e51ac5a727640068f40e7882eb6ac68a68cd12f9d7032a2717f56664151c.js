...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.14438bfb2235af1a70fa640d7ee39a8fd04b93e00c3e505208d4427b74297b8f.js',function(){input.required=false;search();});}
