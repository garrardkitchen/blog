...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f2bf0c68424ba1ed75ac2ab5bd4e8edbedeb4409a6cc779f0d9508f34409f499.js',function(){input.required=false;search();});}
