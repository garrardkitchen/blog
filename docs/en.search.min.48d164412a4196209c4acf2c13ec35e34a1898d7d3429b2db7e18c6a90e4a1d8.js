...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.0a7fcab10171f94f69128b2756710db331c8487090514141f670e1cad6206f2c.js',function(){input.required=false;search();});}
